...
<body>
    ...
    <class class="welcome">
        <h2>
            <strong> Life with Banking!!!</strong> </h2>
    </class>
    ...
    <div id="carouselExampleCaptions" class="carousel slide carousel-fade" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="logos/2.jpg" width="1000" height="400" class="d-block w-100" alt="...">

            </div>
            <div class="carousel-item">
                <img src="logos/1.jpg" width="1000" height="400" class="d-block w-100" alt="...">

            </div>
            <div class="carousel-item">
                <img src="logos/bank1.jpg" width="1000" height="400" class="d-block w-100" alt="...">
